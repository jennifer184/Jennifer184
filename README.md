...
<!-- Testing Project2 -->
 <div align="right">
  <img src="/images/pynguin1.png" align="left" width=30% height="215px">
  <div align="left">
  <h4> Software testing evaluation on Pynguin </h4>
 A 4 month individual Graduate project where I evaluated the effectiveness of Pynguin's autogenerated unit tests with a common open-source Python software, Backtrader. I randomly choose 25 modules, batching them into 5 groups and ran each group with Pynguin using the default configurations. After each batch run I collected the lenght of time to produce each test suite, the total number of tests generated for each module, the pass or fail rate according to Pytest, the statement coverage acheieved, and the mutation score according to MutPy. I found Pynguin was inconsistent in it's ability to provide tests that passed. This may have been due to the 10 minute time-out, where Pynguin may have needed more time to generate better tests. Additionally, all tests did extreamly well in statement coverage and suspisiously achieved a 100% mutation score for killing all mutants. (Python, Bash, Pynguin, MutPy, Pytest, git)
  </div>
 </div>
 <!-- github game -->
 <div>
